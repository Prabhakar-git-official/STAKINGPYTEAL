...
def approval_program():
    ...
    get_Claimedreward = App.localGetEx(Int(0), App.id(), Bytes("MyClaimedReward"))
    ...
    Unstake = Seq(
        [
            ...
            Assert((get_CurrentTime - get_UserTime.value()) >= Int(86400)),
    ...
    claimreward = Seq(
        [
           ...
           If(get_Claimedreward.hasValue())
           .Then(App.localPut(Int(0), Bytes("MyClaimedReward"),App.localGet(Int(0), Bytes("MyClaimedReward"))+ rewardcal2.load()))
           .Else(App.localPut(Int(0), Bytes("MyClaimedReward"),rewardcal2.load())),
